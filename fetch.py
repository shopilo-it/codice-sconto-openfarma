#!/usr/bin/env python3
"""
Recupero codici sconto OpenFarma da shopilo.it
Sursa: https://shopilo.it/negozi/openfarma.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/openfarma.it"
STORE_NAME = "OpenFarma"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per OpenFarma da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-openfarma)"
    }
    try:
